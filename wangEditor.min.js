...
function(e, t) {
	...
	function l(e, t) {
		...
		var i = o('<div class="w-e-droplist"></div>'),
			A = t.$title;
		...
		show: function() {
			...
			if (!($.indexOf(t) >= 0)) {
				var n = t.editor,
					...
					c = this.opt,
					r = o('<div class="w-e-panel-container"></div>'),
					a = c.width || 300;
				...
				g.length && g.get(0).focus(), this.$container = r, this._hideOtherPanels(), $.push(t)
			}
		},
		hide: function() {
			var e = this.menu,
	...
	var z = {};
	 z.emoticon = x,  z.image = D, M.prototype = {
		constructor: M,
		init: function() {
			var e = this,
				t = this.editor;
		...
		uploadImg: function(e) {
			...
			if (e && e.length) {
				...
				if (c(e, function(e) {
					var t = e.name,
						n = e.size;
					return !1 === /\.(jpg|jpeg|png|bmp|gif)$/i.test(t) ? void w.push("【" + t + "】不是图片") : o < n ? void w.push("【" + t + "】大于 " + r + "M") : void m.push(e)
	...
	H.prototype = {
		...
		initSelection: function() {
			var e = this.$textElem,
				t = e.children();
			if (!t.length) return e.append(o("<p><br></p>")), void this.initSelection();
			var n = t.last(),
				i = n.html().toLowerCase(),
				A = n.getNodeName();
			if ("<br>" !== i && "<br/>" !== i || "P" !== A) return e.append(o("<p><br></p>")), void this.initSelection();
			this.selection.createRangeByElem(n, !0), this.selection.restoreSelection()
		},
		_bindEvent: function() {
			var e = 0,
				t = this.txt.html(),
		...
		create: function() {
			this._initConfig(), this._initDom(), this._initCommand(), this._initSelectionAPI(), this._initText(), this._initMenus(), this._initUploadImg(), this.initSelection(), this._bindEvent()
		}
	};
	try {
		document
